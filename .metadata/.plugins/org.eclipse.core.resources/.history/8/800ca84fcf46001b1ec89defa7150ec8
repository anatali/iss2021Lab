...
##############################################################################
##
##  unibo.disi.builder start up script for UN*X
##
##############################################################################
...
APP_NAME="unibo.disi.builder"
APP_BASE_NAME=`basename "$0"`

# Add default JVM options here. You can also use JAVA_OPTS and UNIBO_DISI_BUILDER_OPTS to pass JVM options to this script.
DEFAULT_JVM_OPTS=""
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $UNIBO_DISI_BUILDER_OPTS -classpath "\"$CLASSPATH\""  "$APP_ARGS"
