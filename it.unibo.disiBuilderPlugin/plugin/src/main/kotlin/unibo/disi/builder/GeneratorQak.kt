...
"""
  ...
  fun genQak( dirPath: String, sysName: String ){
    ...
    val projectDirName = genUtils.genDirectory(sourcePath).toString()
      ...
      println(" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EXEC cmd cd $projectPath")
      //CLASSPATH and PROJECT for the eclipse project are generated by the plugin eclipse
      //Runtime.getRuntime().exec("cmd /c cd $projectPath")
      //Runtime.getRuntime().exec("cmd /c gradle eclipse")
      //Runtime.getRuntime().exec( "cmd.exe /c dir %s >> xxx.txt" )
      //Runtime.getRuntime().exec( "cmd.exe /c cd $projectPath; dir %s >> kkk.txt" )
      Runtime.getRuntime().exec( "cmd.exe /c gradle eclipse >> kkk.txt" )
