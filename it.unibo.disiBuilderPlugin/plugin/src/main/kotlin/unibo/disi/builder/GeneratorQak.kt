...
/*
      //CLASSPATH
      val classpathFileName = "${dirPath}/.classpath"
      genUtils.writeOnFile( classpathFileName, builtin.genEclipseClasspth() )

      //PROJECT
      val projectFileName = "${dirPath}/.project"
      genUtils.writeOnFile( projectFileName, builtin.genEclipseProject(sysName) )
*/
    //ACTOR
