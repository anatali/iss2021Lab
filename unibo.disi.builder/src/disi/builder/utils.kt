	  ...
	  fun genMainCtxFile( ctxName: String, content: String ) {
	      try {
			  //generate a new directory
		        ...
		        folder.mkdirs()
		        val mainf     = java.io.File( "$dirName/Main_${ctxName}.kt" ) 
...
"""
	...
	fun genCtxMain(modelFileName : String ){
	...
	fun main() {	//args: Array<String>?
		...
		//generator.genCtxMain( "ctxdemo0", "demo0" );
	}