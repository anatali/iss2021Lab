...
class Prova0actor ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("s1") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_s1", 
							scope, context!!, "local_tout_prova0actor_s1", 1000.toLong() )
					}
					 transition(edgeName="t00",targetState="handleTimeout",cond=whenTimeout("local_tout_prova0actor_s1"))   
